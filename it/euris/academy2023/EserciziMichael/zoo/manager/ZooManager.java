package it.euris.academy2023.EserciziMichael.zoo.manager;
...
import it.euris.academy2023.EserciziMichael.zoo.recinto.Recinto;
import it.euris.academy2023.EserciziMichael.zoo.recinto.TipologiaRecinto;
import it.euris.academy2023.EserciziMichael.zoo.zoo.Zoo;
...
public class ZooManager {
    ...
    public List<Zoo> findZooListByAnimalName(String nomeAnimale){
        return zooList.stream().filter(zoo -> zoo.getRecinti().stream()
